        ...
        <div className="max-w-7xl mx-auto px-4 py-20 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-white/60 text-lg mb-8 leading-relaxed max-w-md">
              FINANS 24 — займы от частных инвесторов без лишних документов. От 5 000 до 200 000 ₽. Одобрение онлайн, перевод на любую карту.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-white/60 mb-6 leading-relaxed">
                FINANS 24 — компания частных инвесторов, предоставляющих займы физическим лицам. За это время мы помогли более 50 000 клиентам решить финансовые вопросы быстро и без лишних сложностей.
              </p>
