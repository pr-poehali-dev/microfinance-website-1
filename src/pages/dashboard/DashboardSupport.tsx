...
export default function DashboardSupport() {
  return (
    <>
      <div className="mt-8 glass rounded-2xl p-6" style={{ border: "1px solid rgba(234,128,52,0.2)" }}>
        <h3 className="font-oswald text-lg font-bold text-white mb-4">Нужна помощь?</h3>
        <div className="grid sm:grid-cols-3 gap-3">
          <a href="tel:+78632708524"
            className="flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:scale-[1.02]"
            style={{ background: "rgba(234,128,52,0.15)", border: "1px solid rgba(234,128,52,0.3)" }}>
            ...
            <div>
              ...
              <div className="text-white/50 text-xs">+7-863-270-85-24</div>
            </div>
          </a>
          <a href="mailto:investorfinans24@ya.ru"
            className="flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:scale-[1.02]"
            style={{ background: "rgba(234,128,52,0.15)", border: "1px solid rgba(234,128,52,0.3)" }}>
            <div className="w-9 h-9 rounded-xl btn-neon flex items-center justify-center shrink-0">
            ...
            <div>
              ...
              <div className="text-white/50 text-xs">investorfinans24@ya.ru</div>
            </div>
          </a>
          <a href="https://t.me/INVESTORFINANS24" target="_blank" rel="noopener noreferrer"
            ...
            <div>
              ...
              <div className="text-white/50 text-xs">@INVESTORFINANS24</div>
            </div>
          </a>
        </div>
      </div>
      ...
      <a href="tel:+78632708524"
        ...
        style={{ background: "linear-gradient(135deg,#ea8034,#f0994a)", boxShadow: "0 0 24px rgba(240,153,74,0.4)" }}>
